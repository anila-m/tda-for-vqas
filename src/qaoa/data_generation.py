...
def prepare_cost_function(
    operator: PauliSum, backend: WavefunctionSimulator, n_layers: int = 1
...
def generate_data(
    ...
    print("[INFO] Done: Create directory")
